...
const CartDrawer = () => {
  ...
  (userCart as Cart).items?.map((item: Item) =>
    totalArray.push(+item.qty * +item.garmet.variant.price)
  );
      ...
      {userCart ? (
        <TableContainer component={Paper} className={classes.paper}>
          <Table className={classes.table} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell align="center">Garmet</TableCell>
                ...
                <TableRow key={item._id}>
                  <TableCell align="center">
                    <img
                      ...
                      src={item.garmet.image}
                      alt="country-flag"
                    />
                  </TableCell>
                  <TableCell align="center">{item.garmet.name}</TableCell>
                  <TableCell align="center">{+item.qty}</TableCell>
                  <TableCell align="center">
                    ${+(+item.qty * +item.garmet.variant.price).toFixed(2)}
                  </TableCell>
                  <TableCell align="center">
                    <IconButton
                      ...
                      color="inherit"
                      onClick={() => {
                        dispatch(deleteGarmetCart(item.garmet._id));
